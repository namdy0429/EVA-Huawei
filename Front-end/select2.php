...
<div class="site-wrapper container" style="padding-bottom: 50px; vertical-align: center;">
  ...
  <div class="row" style="margin-top: 100px;" id="select1">
        ...
        <form action="./select3.php" method="GET">
          <div class="row">
            ...
            <div class="col-sm-10">
              ...
              <select class="form-control" id="layer" name="layer" style="margin-: auto;">';
            // 폴더명 지정
            ...
            $dir = $back_path."Data/Architecture/android/".$_REQUEST['recovery'];
            echo $dir."<br>";
